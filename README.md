...
[![Next](https://img.shields.io/badge/next-V3%20and%20V4-blue)]()
...
| 2025 | **V1**   | 引入 jieba，从字升级到词 | 混沌的选字机 |
| 2025 | **V2**   | 两两共现 + 混合权重 `0.5×邻接 + 0.25×共现` | 初具关联的智者 |
| 2025 | **V2.1** | 实时记忆功能——意外造出**电子鹦鹉** | 🦜 **电子鹦鹉** |
| 2025 | **V2.5** | Selenium 搜索注入 | 会查资料的鹦鹉 |
| 2025.12.03 | —        | 跟同学讨论"电子鹦鹉"现象 | — |
| 2025.12.08 | —        | DeepMind 发 Evo-Memory，核心思想不谋而合 | — |
| 2026.07 | —        | 归档整理，建立仓库 | — |
| 未来 | **V3**   | 词距离权重（权重 = 1 / 距离） | 数学的精算师 |
...
**统计阶段**：加载长篇文本语料 → `jieba` 分词 → 构建两个字典：

- `word_dic`：词与词的**邻接**统计（谁后面常跟谁）
- `word_dic_2`：词与词的**同句共现**统计（谁跟谁关系铁）

**预测阶段**：`Score(w) = 0.5 × 邻接 + 0.25 × 共现`
